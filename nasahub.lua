...
shared.LoaderTitle = "Nasa On Top In Blox Fruit";
...
local v7 = CreateObject("ImageLabel", {
    ...
    Image = "rbxassetid://80356489309409",
...
--     end
-- end);
local v14 = loadstring(game:HttpGet("https://raw.githubusercontent.com/xi3000/fluentTrau/refs/heads/main/main.lua%20FluentTrau"))();
...
v23.Draggable = true;
v23.Image = "http://www.roblox.com/asset/?id=80356489309409";
v24.Parent = v23;
...
v16.Home:AddButton({
    ...
    Callback = function()
        setclipboard("memaybeo tao đang lang thang làm gì có box");
    end
});
...
if Sea3 then
    ...
    local v492 = v16.Main:AddToggle("ToggleCake", {
        ...
        Description = "farm material cake",
        Default = false
    });
    local v493 = true;
    ...
    local v495 = v16.Main:AddToggle("ToggleSpawnCake", {
        ...
        Description = "spawn cake prince boss",
        Default = true
    });
...
if Sea3 then
    ...
    local v500 = v16.Sea:AddToggle("ToggleEspKitsune", {
        ...
        Description = "esp kitsune island",
        Default = false
    });
    ...
    local v501 = v16.Sea:AddToggle("ToggleTPKitsune", {
        ...
        Description = "tp to kitsune island",
        Default = false
    });
...
if Sea3 then
    ...
    local v517 = v16.Sea:AddToggle("AutoComeHydra", {
        ...
        Description = "tp back to hydra island",
        Default = false
    });
    ...
    local v526 = v16.Sea:AddToggle("ToggleShip", {
        Title = "Đấm Tàu",
        Description = "kill ship in sea event",
        Default = false
    });
    ...
    local v527 = v16.Sea:AddToggle("ToggleGhostShip", {
        Title = "Đấm Tàu Ma",
        Description = "killer ghost ship in sea event",
        Default = false
    });
...
if Sea3 then
    ...
    v16.Sea:AddButton({
        ...
        Description = "fly to high in mirage",
        Callback = function()
            TweenToHighestPoint();
        end
    });
...
local v66 = v16.Sea:AddToggle("ToggleTpAdvanced", {
    ...
    Description = "tp to advanced fruit dealer on mirage",
    Default = false
});
...
local v106 = v16.Status:AddToggle("MyToggle", {
    Title = "Spam Tham Gia Job ID|spam join with job id",
    Default = false
});
...
local v107 = v16.Stats:AddToggle("ToggleMelee", {
    Title = "Nâng Đấm",
    Description = "choose stats melee",
    Default = false
});
...
local v108 = v16.Stats:AddToggle("ToggleDe", {
    Title = "Nâng Máu",
    Description = "choose stats defense",
    Default = false
});
...
local v109 = v16.Stats:AddToggle("ToggleSword", {
    Title = "Nâng Kiếm",
    Description = "choose stats sword",
    Default = false
});
...
local v111 = v16.Stats:AddToggle("ToggleFruit", {
    Title = "Nâng Trái",
    Description = "choose stats fruit",
    Default = false
});
...
local v119 = v16.Teleport:AddToggle("ToggleAutoSea2", {
    ...
    Description = "quest to tp second sea",
    Default = false
});
...
local v120 = v16.Teleport:AddToggle("ToggleAutoSea3", {
    ...
    Description = "auto quest for third sea",
    Default = false
});
...
local v111 = v16.Fruit:AddToggle("ToggleFruit", {
    Title = "Mua Trái Chọn",
    Description = "buy fruit in stock choose",
    Default = false
});
...
local v124 = v16.Fruit:AddDropdown("DropdownPermanentFruit", {
    ...
    Description = "choose premium fruit",
    Values = Table_DevilFruitSniper,
    Multi = false,
    Default = 1
});
...
local v125 = v16.Fruit:AddToggle("TogglePermanentFruit", {
    ...
    Description = "change premium fruit",
    Default = false
});
...
local v134 = v16.Fruit:AddToggle("ToggleEspRealFruit", {
    ...
    Description = "fruit to get kentrick v2",
    Default = false
});
...
local v140 = v16.Raid:AddToggle("ToggleNextIsland", {
    ...
    Description = "auto raid and tp to next island",
    Default = false
});
...
local v142 = v16.Raid:AddToggle("ToggleGetFruit", {
    ...
    Description = "gets fruit below 1m beli",
    Default = false
});
...
local v143 = v16.Raid:AddToggle("ToggleLaw", {
    ...
    Description = "buy chip and auto law",
    Default = false
});
...
local v144 = v16.Race:AddToggle("ToggleHumanandghoul", {
    ...
    Description = "done trials human or ghoul race",
    Default = false
});
...
local v146 = v16.Race:AddToggle("ToggleKillTrial", {
    ...
    Description = "killer player in trials",
    Default = false
});
...
v16.Shop:AddButton({
    Title = "Black Leg",
    Description = "get black leg|lấy black legs",
    Callback = function()
...
v16.Shop:AddButton({
    Title = "Electro",
    Description = "get elextro | lấy electro",
    Callback = function()
...
v16.Shop:AddButton({
    ...
    Description = "get fishman karate|lấy fishman karate",
    Callback = function()
...
v16.Shop:AddButton({
    Title = "Dragon Claw",
    Description = "get dragon claw|lấy dragon claw",
    Callback = function()
...
v16.Shop:AddButton({
    ...
    Description = "Chỉ Ở Biển 3|only third sea",
    Callback = function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("requestEntrance", Vector3.new(5661.5322265625, 1013.0907592773438, - 334.9649963378906));
...
local v155 = v16.Sea:AddToggle("ToggleTPFrozenDimension", {
    Title = "tp to island frozen",
    Description = "dịch chuyển đến frozen",
    Default = false
});
...
if Sea3 then
    local v561 = v16.Sea:AddParagraph({
        Title = "check frozen status",
        Content = "check status leviathan in sever or no"
    });
    spawn(function()
        pcall(function()
            while wait() do
...
local v157 = v16.Sea:AddToggle("ToggleBlazeEmber", {
    Title = "gets red fire",
    Description = "auto gets red fire",
    Default = false
});
...
local v158 = v16.Sea:AddToggle("ToggleReceiveQuest", {
    Title = "claim quest red fire",
    Description = "Bật Lên 1 Lần Là Nhận 1 Nhận Nữa Thì Tắt Bật Lại|Turn it on once and you'll get it. Once you get it, turn it off and turn it on again",
    Default = false
});
...
local v159 = v16.Sea:AddParagraph({
    ...
    Content = "check red fire quest status"
});
spawn(function()
    pcall(function()
        while wait() do
...
local v160 = v16.Sea:AddToggle("ToggleHydraTree", {
    Title = "broken trees in hydra",
    Description = "broken trees in hydra claim dojo quest",
    Default = false
});
...
v156:AddButton({
    Title = "tp to dojo quest",
    Description = "teleport to claim dojo quest",
    Callback = function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("requestEntrance", Vector3.new(5661.5322265625, 1013.0907592773438, - 334.9649963378906));
        Tween2(CFrame.new(5814.42724609375, 1208.3267822265625, 884.5785522460938));
    end
...
local v164 = v16.Sea:AddToggle("ToggleCollectFireFlowers", {
    ...
    Description = "auto farm red follower dojo race",
    Default = false
});
...
local v167 = v16.Sea:AddToggle("ToggleTrialTeleport", {
    Title = "tp to draco race",
    Description = "teleport to draco race when done volcano|dịch chuyển đến cửa trials draco",
    Default = false
});
...
local v169 = v16.Sea:AddParagraph({
    ...
    Content = "check status in sever or no"
});
spawn(function()
    pcall(function()
        while wait() do
...
local v170 = v16.Sea:AddToggle("ToggleTPVolcano", {
    ...
    Description = "tp when volcano spawn in sever",
    Default = false
});
...
local v171 = v16.Sea:AddToggle("ToggleDefendVolcano", {
    Title = "defender island",
    Description = "defender volcano",
    Default = false
});
...
local v177 = v16.Sea:AddToggle("ToggleCollectEgg", {
    Title = "auto eggs",
    Description = "auto eggs when done volcano|lấy trứng khi xong volcano",
    Default = false
});
