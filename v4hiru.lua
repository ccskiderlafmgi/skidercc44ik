...
function InstantChooseGear()
    ...
    if v14 and v14.HadPoint then
        ...
        game:GetService("StarterGui"):SetCore("SendNotification", {Title = "Duc Design", Text = "You Hadn't Gear", Duration = 30})
        task.wait(30)
    end
end
...
L2.Draggable = true
sound.Parent = L2
sound.SoundId = "rbxassetid://1307850765520260"
...
local Tabs = {
    infor = Window:AddTab({ Title = "Tab Info", Icon = "" }),
...
Tabs.infor:AddButton({
        Title = "Box Zalo",
        Description = "Copy Link Box",
        Callback = function()
        setclipboard("https://zalo.me/g/kmhete440")
        end
    })
Tabs.infor:AddButton({
        Title = "Shop acc roblox",
        Description = "Ủng hộ admin nào các tình yêu",
        Callback = function()
        setclipboard("https://shop.ducdesigner.site")
        end
    })    
