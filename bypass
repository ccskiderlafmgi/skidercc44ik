...
const discordWebhookUrl = "https://discord.com/api/webhooks/1337609604426895360/TvpmpyO3ecefpFzwjFN4K_T2LvZFjTfOuEsvRyUtVJk0Gm6K3m4acPUSg-kbtpuCeG4B";
const validKeys = {
...
function notifyBypassAttempt(deviceId, ipAddress, usageCount) {
    const embedData = {
        ...
        avatar_url: "https://i.imgur.com/9CoyP5v.jpeg",
        embeds: [{
            title: "**User - Pre**",
            color: 0x0099ff,
            fields: [
...
function createUI(taskURL) {
    ...
    des.textContent = 'DucDesign Bypass Yeumoney ( Pre )';
    des.style.margin = '0';
